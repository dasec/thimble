...
/**
 * @file include/thimble/finger/all.h
 *
 * @brief
 *            Provides all the functionalities that are provided by
 *            the headers in <code>thimble/finger/</code>.
 *
 * @author Benjamin Tams
 */

#ifndef THIMBLE_FINGER_ALL_H_
#define THIMBLE_FINGER_ALL_H_
